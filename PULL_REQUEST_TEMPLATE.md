...
<!-- Explain what changed and why. Keep the change focused. -->

## Related issue

<!-- Link the issue this change addresses, for example: Closes #123. Explain why no issue exists when applicable. -->
...
- Roblox client/server runtime:
- Roblox Studio version:
- Project or module version or commit:
- Test environment:
- Test steps and results:

## Compatibility and migration

<!-- Describe effects on configuration, DataStore schemas, remotes, APIs, dependencies, device support, or published experiences. State "None" when not applicable. -->

## Screenshots or video

<!-- Required for visible UI or gameplay changes. Remove this section when not applicable. -->

## Checklist

- [ ] I agree to follow the [QBCore Roblox Code of Conduct](https://github.com/qbcore-roblox/.github/blob/main/CODE_OF_CONDUCT.md).
...
- [ ] I tested the change with current Roblox Studio and client/server runtime versions.
...
- [ ] I added or updated configuration examples, data migrations, and translations where applicable.
