# Contributing to QBCore Roblox

Thank you for helping improve QBCore Roblox. These guidelines apply across the
organization unless a repository documents a more specific requirement.

## Choose the right channel

- Use a bug form for a reproducible defect in an official QBCore Roblox project.
...
- Use the [QBCore Roblox project](https://github.com/qbcore-roblox/qbcore-rp) and
  [official Discord](https://discord.gg/qbcore) for installation,
  configuration, and usage support.
- Follow the [QBCore Roblox Code of Conduct](CODE_OF_CONDUCT.md) whenever you
...
There is no single test command shared across QBCore Roblox repositories. At
minimum:

- Run every check or lint workflow provided by the repository.
- Test with current Roblox Studio and client/server runtime versions and
  compatible official dependencies.
- Record the exact project or module commit, Studio version, and runtime channel.
- Verify Studio Output and relevant client and server logs for new warnings or
  errors.
- Test Studio play sessions, server/client startup, and the smallest reliable
  reproduction for the changed behavior.
- Test fresh installation and upgrade paths when changing configuration or
  persisted data.
- Test relevant resolutions, input methods, and device classes for
  user-interface changes, and include screenshots or video.
...
manual Roblox Studio and published-experience testing.
